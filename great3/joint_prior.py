...
def make_joint_prior_simple(type="great3-rgc-exp-hybrid-cosmosg-deep03"):
    """
    Make a joint prior 
    """
...
# from fitting without priors to the deep fields in the
# control, ground, constant branch
# see fit_prior.py
